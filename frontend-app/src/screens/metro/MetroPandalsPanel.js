...
export default function MetroPandalsPanel() {
  ...
  const handleSubmit = async (sourceId, destinationId) => {
    ...
    setError(null);
    try {
      setRoute(await fetchPandalRoute(sourceId, destinationId, 'metro'));
    } catch (e) {
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.collapsibleWrap}>
        <CollapsiblePandalsList
          ...
          subtitle="Top pandals reachable via Kolkata Metro network"
