      ...
      <ScreenBackground>
        ...
        >
          <View style={styles.card}>
            ...
            {/* Title & Description */}
            <Text style={styles.title}>Profile & Google Sign-In</Text>
            <Text style={styles.subtitle}>
              Personal accounts, Google sign-in, cloud sync, and custom puja itineraries are currently under active development and will be available in an upcoming update.
            </Text>
